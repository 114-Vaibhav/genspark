    ...
    public class BankingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Customer>(c =>
            {
                ...
                c.Property(c => c.DateOfBirth).HasColumnType("date");
                //seeding
                c.HasData(new Customer() { Id = 101, Name = "Ramu", Phone = "9876543210", DateOfBirth= new DateOnly(2000,12,12), Email = "ramu@gmail.com", Status = "Active" });
            });
