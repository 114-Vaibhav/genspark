...
builder.Services.AddScoped<IRepository<int, Transaction>, Repository<int,Transaction>>();
builder.Services.AddScoped<IRepository<int, AccountStatement>, Repository<int,AccountStatement>>();
